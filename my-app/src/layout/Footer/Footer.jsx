...
const Footer = () => {
 ...
 <div className='footer__left'>
        <div>
            <h1><img src="https://preview.colorlib.com/theme/timezone/assets/img/logo/logo2_footer.png.webp" alt="" /></h1>
       ...
       <div className='footer__right'>
        <div>
            <p>Copyright ©2024 All rights reserved | This template is made with <i style={{color:'red'}} class="fa-regular fa-heart"></i>  by <span>Colorlib</span></p>
        </div>
        <div className='icon'>
